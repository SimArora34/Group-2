...
// Import onboarding images from assets
// Replace these with actual image assets when available
const imageMap: Record<string, ImageSourcePropType | null> = {
  "pool-funds": require("../../assets/images/Money.png"),
  "credit-score": require("../../assets/images/Credit_score.png"),
  security: require("../../assets/images/Security.png"),
  wallet: require("../../assets/images/Wallet.png"),
};

// Fallback colors and emojis when images are not yet available
const SLIDE_COLORS = [Colors.primaryLight, "#FFF8E1", "#E8EAF6", "#FCE4EC"];
const SLIDE_EMOJIS = ["💰", "📊", "🛡️", "👛"];
const SLIDE_KEYS = ["pool-funds", "credit-score", "security", "wallet"];
      ...
      {source ? (
        ...
        <View
          style={[
            ...
            { backgroundColor: SLIDE_COLORS[index % SLIDE_COLORS.length] },
          ]}
        >
          <Text style={styles.imageEmoji}>
            {SLIDE_EMOJIS[index % SLIDE_EMOJIS.length]}
          </Text>
        </View>
      )}
      <TouchableOpacity>
...
export default function OnboardingScreen() {
  ...
  const handleScroll = (e: any) => {
    const index = Math.round(
      e.nativeEvent.contentOffset.x / (SCREEN_WIDTH - 48 + 16),
    );
