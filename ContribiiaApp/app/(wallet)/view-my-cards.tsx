...
const styles = StyleSheet.create({
  ...
  cardItemNumber: { color: Colors.white, fontSize: 15, fontWeight: '600', letterSpacing: 1.4 },
  menuBtn: { padding: 6 },
  cardItemBottom: {
    height: 36,
    borderRadius: 10,
  ...
  cardItemFooterLabel: { fontSize: 10, color: 'rgba(255,255,255,0.7)' },
  cardItemFooterVal: { fontSize: 12, fontWeight: '700', color: Colors.white, marginTop: 2 },
  dropdown: {
    position: 'absolute',
    top: 50,
    right: 16,
  ...
  dropdownText: { fontSize: 13, color: Colors.textDark, fontWeight: '500' },
  dropdownDivider: {
    height: 1,
