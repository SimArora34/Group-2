      ...
      <SafeAreaView style={styles.container} edges={["top", "bottom"]}>
        <ScrollView contentContainerStyle={styles.scroll}>
          ...
          <Text style={styles.successDesc}>
            Your virtual card has been <Text style={styles.bold}>successfully frozen.</Text>
            {"\n\n"}
    ...
    return (
      <SafeAreaView style={styles.container} edges={["top", "bottom"]}>
        <ScrollView contentContainerStyle={styles.scroll}>
          ...
          <Text style={styles.successDesc}>
            Your virtual card is now <Text style={styles.bold}>active.</Text>
            {"\n\n"}
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.noticeBox}>
          <Text style={styles.noticeText}>
            <Text style={styles.bold}>Note:</Text> This will freeze your card, and will also affect
            any automated or pending payments done by this card.
            {"\n\n"}
...
const styles = StyleSheet.create({
  ...
  cardBalanceLabel: { color: "rgba(255,255,255,0.7)", fontSize: 12 },
  cardBalanceAmt: { color: Colors.white, fontSize: 28, fontWeight: "800" },
  freezeBtn: {
